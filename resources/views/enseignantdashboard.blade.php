                        ...
                        <div class="row">
                            <div class="col-12 sm-mb-30">
                                <a href="#" data-toggle="modal" data-target="#add-category"
                                    ...
                                    <i class="fa fa-plus pr-2"></i> Ajouter Evénement
                                </a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Ajouter Nouvelle Evenement</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-success save-event">Cree Evenement</button>
                                    ...
                                    <div class="modal-body p-20">
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="control-label">Choisir la couleur dans la categorie</label>
                    ...
                    <div class="card card-statistics h-100">
                        ...
                        <div class="btn-group info-drop">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><i class="text-primary ti-reload"></i>Actualiser</a>
